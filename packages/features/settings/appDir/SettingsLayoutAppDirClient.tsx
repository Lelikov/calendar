  ...
  const tabs: VerticalTabItemProps[] = [
    {
      ...
      icon: "user",
      children: [
        { name: "profile", href: "/settings/my-account/profile", onlyAdmin: false },
        { name: "general", href: "/settings/my-account/general", onlyAdmin: false },
        { name: "calendars", href: "/settings/my-account/calendars", onlyAdmin: true },
        { name: "conferencing", href: "/settings/my-account/conferencing", onlyAdmin: true },
        { name: "appearance", href: "/settings/my-account/appearance", onlyAdmin: false },
        { name: "out_of_office", href: "/settings/my-account/out-of-office", onlyAdmin: true },
      ],
    },
    {
      name: "security",
      ...
      icon: "key",
      children: [
        { name: "password", href: "/settings/security/password", onlyAdmin: false },
        { name: "impersonation", href: "/settings/security/impersonation", onlyAdmin: true },
        { name: "2fa_auth", href: "/settings/security/two-factor-auth", onlyAdmin: true },
      ],
    },
    {
      name: "billing",
    ...
    },
    {
      ...
      children: [
        ...
        { name: "OAuth Clients", href: "/settings/organizations/platform/oauth-clients", onlyAdmin: true },
        {
          name: "SSO",
...
const adminRequiredKeys = ["admin", "teams", "developer", "billing"];
...
const useTabs = () => {
  ...
  const processTabsMemod = useMemo(() => {
    ...
    return processedTabs.filter((tab: VerticalTabItemProps) => {
      ...
      tab.children = tab.children?.filter((child: VerticalTabItemProps) => {
        return child.onlyAdmin == isAdmin;
      });
